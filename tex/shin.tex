...
\item[] {\bf Research Intern} (Jan. 2016 -- Jun. 2016), Energy Process Engineering Laboratory, Seoul National University. (Supervisor: Jong Min Lee).
\end{itemize}
...
\item[] {\bf SimpleNL.jl} (Main developer): a nonlinear modeling framework.
