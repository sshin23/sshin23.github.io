...
% \subsection*{Current Research Funding}
% \begin{itemize}[leftmargin=*]
%   \item[] 
% \end{itemize}
...
\begin{itemize}[leftmargin=*]
  ...
  \begin{itemize}[leftmargin=*]
    \item[] {\bf Geunseo Song} (Visiting Student; Ewha Womans University) \hfill (Spring 2025--)
    \item[] {\bf Natalie Chung} (UROP) \hfill (Spring 2025--)
    \item[] {\bf Boxun Huang} (PhD Student) \hfill (Spring 2025--)
    \item[] {\bf Sanjay Johnson} (PhD Student) \hfill (Spring 2025--)
    \item[] {\bf Xiaomian Yang} (PhD Student) \hfill (Spring 2025--)
