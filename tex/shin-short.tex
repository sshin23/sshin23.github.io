...
% \item[] PI. Optimal Utilization Strategies of Utility-Scale Battery Storage: Slowing Down Degradation in the Face of Complex Physics and Uncertainties. MIT Energy Initiative. Total \$150,000. 2024-2026.
% \item[] PI. Characterizing the Trade-Off between CO2 Capture Rate and Energy Efficiency in Amine-Based Carbon Capture under Variable Feed Conditions. Total \$250,000. 2025-2027.
% \end{itemize}
...
\item[] \textbf{Conference session organization}: Organized ``accelerated computing for mathematical programming'' session at INFORMS Annual Meeting (2024)
  % , International Program Committee of IFAC NMPC Conference (2024), and session reviewer and chair of AIChE CAST Division (2022, 2024).
